...
class RoIHeads(torch.nn.Module):
    ...
    def postprocess_detections(self,
        ...
        for boxes, scores, image_shape in zip(pred_boxes_list, pred_scores_list, image_shapes):
            ...
            boxes, scores, labels, inds = boxes[keep], scores[keep], labels[keep], inds[keep]
            ...
            ret_ind = inds // (num_classes - 1)

            all_boxes.append(boxes)
            all_scores.append(scores)
            all_labels.append(labels)
            all_inds.append(ret_ind)

        return all_boxes, all_scores, all_labels, all_inds
    ...
    def forward(self,
        ...
        box_pool = self.box_roi_pool(features, proposals, image_shapes)
        box_features = self.box_head(box_pool)
        box_pool = F.avg_pool2d(box_pool, (7,7)).view(1000, 256)
        ...
        if self.training:
            ...
            boxes, scores, labels, keep_idx = self.postprocess_detections(class_logits, box_regression, proposals, image_shapes)
